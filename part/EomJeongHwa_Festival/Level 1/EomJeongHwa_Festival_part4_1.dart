...
class EomJeongHwa_Festival_part4_1 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  EomJeongHwa_Festival_part4_1(this._videoID, this._videoTitle);

  factory EomJeongHwa_Festival_part4_1.fromUrl(
      String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return EomJeongHwa_Festival_part4_1(videoID, videoTitle);
  }
  @override
  EomJeongHwa_Festival_part4_1State createState() =>
      EomJeongHwa_Festival_part4_1State();
...
class EomJeongHwa_Festival_part4_1State
    extends State<EomJeongHwa_Festival_part4_1> {
