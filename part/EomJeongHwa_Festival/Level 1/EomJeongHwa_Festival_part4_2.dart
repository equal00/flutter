...
class EomJeongHwa_Festival_part4_2 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  EomJeongHwa_Festival_part4_2(this._videoID, this._videoTitle);

  factory EomJeongHwa_Festival_part4_2.fromUrl(
      String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return EomJeongHwa_Festival_part4_2(videoID, videoTitle);
  }
  @override
  EomJeongHwa_Festival_part4_2State createState() =>
      EomJeongHwa_Festival_part4_2State();
...
class EomJeongHwa_Festival_part4_2State
    extends State<EomJeongHwa_Festival_part4_2> {
