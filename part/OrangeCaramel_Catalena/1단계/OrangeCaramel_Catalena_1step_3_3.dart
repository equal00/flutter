...
class OrangeCaramel_Catalena_1step_3_3 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  OrangeCaramel_Catalena_1step_3_3(this._videoID, this._videoTitle);

  factory OrangeCaramel_Catalena_1step_3_3.fromUrl(
      String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return OrangeCaramel_Catalena_1step_3_3(videoID, videoTitle);
  }
  @override
  OrangeCaramel_Catalena_1step_3_3State createState() =>
      OrangeCaramel_Catalena_1step_3_3State();
...
class OrangeCaramel_Catalena_1step_3_3State
    extends State<OrangeCaramel_Catalena_1step_3_3> {
