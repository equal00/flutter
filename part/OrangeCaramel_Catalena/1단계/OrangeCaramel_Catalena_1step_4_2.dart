...
class OrangeCaramel_Catalena_1step_4_2 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  OrangeCaramel_Catalena_1step_4_2(this._videoID, this._videoTitle);

  factory OrangeCaramel_Catalena_1step_4_2.fromUrl(
      String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return OrangeCaramel_Catalena_1step_4_2(videoID, videoTitle);
  }
  @override
  OrangeCaramel_Catalena_1step_4_2State createState() =>
      OrangeCaramel_Catalena_1step_4_2State();
...
class OrangeCaramel_Catalena_1step_4_2State
    extends State<OrangeCaramel_Catalena_1step_4_2> {
