...
class OrangeCaramel_Catalena_part1 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  OrangeCaramel_Catalena_part1(this._videoID, this._videoTitle);

  factory OrangeCaramel_Catalena_part1.fromUrl(
      String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return OrangeCaramel_Catalena_part1(videoID, videoTitle);
  }
  @override
  OrangeCaramel_Catalena_part1State createState() =>
      OrangeCaramel_Catalena_part1State();
...
class OrangeCaramel_Catalena_part1State
    extends State<OrangeCaramel_Catalena_part1> {
