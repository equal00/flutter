...
class OrangeCaramel_Catalena_part4 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  OrangeCaramel_Catalena_part4(this._videoID, this._videoTitle);

  factory OrangeCaramel_Catalena_part4.fromUrl(
      String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return OrangeCaramel_Catalena_part4(videoID, videoTitle);
  }
  @override
  OrangeCaramel_Catalena_part4State createState() =>
      OrangeCaramel_Catalena_part4State();
...
class OrangeCaramel_Catalena_part4State
    extends State<OrangeCaramel_Catalena_part4> {
