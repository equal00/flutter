...
class YoungTak_Great_1step_1_1 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  YoungTak_Great_1step_1_1(this._videoID, this._videoTitle);

  factory YoungTak_Great_1step_1_1.fromUrl(String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return YoungTak_Great_1step_1_1(videoID, videoTitle);
  }
  @override
  YoungTak_Great_1step_1_1State createState() =>
      YoungTak_Great_1step_1_1State();
...
class YoungTak_Great_1step_1_1State extends State<YoungTak_Great_1step_1_1> {
