...
class YoungTak_Great_1step_1_2 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  YoungTak_Great_1step_1_2(this._videoID, this._videoTitle);

  factory YoungTak_Great_1step_1_2.fromUrl(String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return YoungTak_Great_1step_1_2(videoID, videoTitle);
  }
  @override
  YoungTak_Great_1step_1_2State createState() =>
      YoungTak_Great_1step_1_2State();
...
class YoungTak_Great_1step_1_2State extends State<YoungTak_Great_1step_1_2> {
