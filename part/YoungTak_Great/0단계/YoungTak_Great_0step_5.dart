...
class YoungTak_Great_0step_5 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  YoungTak_Great_0step_5(this._videoID, this._videoTitle);

  factory YoungTak_Great_0step_5.fromUrl(String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return YoungTak_Great_0step_5(videoID, videoTitle);
  }
  @override
  YoungTak_Great_0step_5State createState() => YoungTak_Great_0step_5State();
...
class YoungTak_Great_0step_5State extends State<YoungTak_Great_0step_5> {
