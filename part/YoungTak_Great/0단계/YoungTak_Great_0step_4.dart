...
class YoungTak_Great_0step_4 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  YoungTak_Great_0step_4(this._videoID, this._videoTitle);

  factory YoungTak_Great_0step_4.fromUrl(String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return YoungTak_Great_0step_4(videoID, videoTitle);
  }
  @override
  YoungTak_Great_0step_4State createState() => YoungTak_Great_0step_4State();
...
class YoungTak_Great_0step_4State extends State<YoungTak_Great_0step_4> {
