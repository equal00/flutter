...
class YoungTak_Great_0step_3 extends StatefulWidget {
  final String _videoID;
  final String _videoTitle;

  YoungTak_Great_0step_3(this._videoID, this._videoTitle);

  factory YoungTak_Great_0step_3.fromUrl(String videoUrl, String videoTitle) {
    String videoID = extractVideoIdFromUrl(videoUrl);
    return YoungTak_Great_0step_3(videoID, videoTitle);
  }
  @override
  YoungTak_Great_0step_3State createState() => YoungTak_Great_0step_3State();
...
class YoungTak_Great_0step_3State extends State<YoungTak_Great_0step_3> {
